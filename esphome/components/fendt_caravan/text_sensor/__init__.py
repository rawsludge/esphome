...
CONFIG_SCHEMA = cv.typed_schema(
    {
        ...
        "alde_available": _text_schema(
            icon="mdi:air-filter", key_name="HEATER_AVAILABLE"
        ),
        "fridge_available": _text_schema(
            icon="mdi:fridge", key_name="FRIDGE_AVAILABLE"
        ),
        "fridge_source": _text_schema(icon="mdi:power-plug", key_name="FRIDGE_SOURCE"),
        "fridge_type": _text_schema(icon="mdi:fridge", key_name="FRIDGE_TYPE"),
        "water_level": _text_schema(icon="mdi:waves", key_name="WATER_LEVEL"),
    }
)
